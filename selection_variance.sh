...
EOF
		python -u create_training_data.py -tops $M $I>./logs_selection_variance/output/create_training_data.$M.$I.out 2>./logs_selection_variance/error/create_training_data.$M.$I.err		
		...
		ssh rd804@amarel.rutgers.edu "bash -s" <./remote_commands.sh $M $I tops

	# obtain classifer out	
		ssh rd804@pascal /opt/anaconda3/bin/python -u ./ypred_method/classifier_training.py -tops $M $I>./logs_selection_variance/output/classifier_training.$M.$I.out 2>./logs_selection_variance/error/classifier_training.$M.$I.err
	...
	# find highest score
		python -u sort_and_find_new_variable.py $M $I -tops>./logs_selection_variance/output/sort.$M.$I.out 2>./logs_selection_variance/error/sort.$M.$I.err	
