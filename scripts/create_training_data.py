...
if args.qg:
	trainlabels=np.load('/het/p2/ranit/qg/data/y_train.npy')
	vallabels=np.load('/het/p2/ranit/qg/data/y_val.npy')
	testlabels=np.load('/het/p2/ranit/qg/data/y_test.npy')
